...
const LawsSelectTen: LawsSelect = {
  items: [
    ...
    { value: '-1 (-10 + 9)', label: '-1 (-10 + 9)', id: 10 },
    { value: '-2 (-10 + 8)', label: '-2 (-10 + 8)', id: 11 },
    { value: '-3 (-10 + 7)', label: '-3 (-10 + 7)', id: 12 },
    { value: '-5 (-10 + 5)', label: '-5 (-10 + 5)', id: 13 },
    { value: '-6 (-10 + 4)', label: '-6 (-10 + 4)', id: 14 },
    { value: '-4 (-10 + 6)', label: '-4 (-10 + 6)', id: 15 },
    { value: '-7 (-10 + 3)', label: '-7 (-10 + 3)', id: 16 },
    { value: '-8 (-10 + 2)', label: '-8 (-10 + 2)', id: 17 },
    { value: '-9 (-10 + 1)', label: '-9 (-10 + 1)', id: 18 },
  ],
};
